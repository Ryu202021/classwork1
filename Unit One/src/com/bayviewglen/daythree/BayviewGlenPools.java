...
public class BayviewGlenPools {
	...
	public static void main(String[] args) {
		...
		double transitionSides = (TRANSITION_HYP * DE_END_H) + ((Math.sqrt((Math.pow(TRANSITION_HYP, 2)) - (Math.pow(DE_END_H, 2)))) * SH_END_H) / 2;
		...
		System.out.println("5. The price of the liner is $60/m^2. The price for the pool is $" + (int)linerTotalCost + "." + (int)linerCents + ".");
